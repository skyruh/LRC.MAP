  ...
  return (
    <main className="min-h-screen relative flex flex-col items-center p-4 sm:p-24 bg-black text-white">
      ...
      <a
        ...
        className="fixed bottom-8 right-8 z-50 group flex items-center gap-3 transition-opacity duration-500 hover:opacity-100 opacity-60"
      >
        <div className="text-right hidden sm:block">
          <div className="text-white text-[10px] font-bold uppercase tracking-wider group-hover:text-white transition-colors">GitHub</div>
          <div className="text-neutral-600 text-[10px] group-hover:text-neutral-400 transition-colors">Source Code</div>
        </div>
